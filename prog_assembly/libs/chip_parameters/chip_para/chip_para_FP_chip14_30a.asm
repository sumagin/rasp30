...
/**********************************/
.set ADC_1nA, 6376 /* 1nA ADC value */

/* sub threshold */
.set FPS_GATE_S_SWC, 0x7030 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x7030 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x7030 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_MITE, 0x7030 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x7030 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
.set FPS_INJ_T_DIRSWC, 1 /* Injection time (*10us) */
.set FPS_NUM_DIRSWC, 60 /* # of Fine Progrm */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x7030 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x7030 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x7030 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x7030 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_DIRSWC, 0x7030 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
.set FPL_GATE_S_OTA, 0x3f30 /* Gate(OTA) = 2.1V */
...
.set FPL_GATE_S_MITE, 0x3f30 /* Gate(MITE) = 2.1V */
...
.set FPL_GATE_S_DIRSWC, 0x0e30 /* Gate(DIRSWC) = 1.7V */
