...
/* sub threshold */
.set FPS_GATE_S_SWC, 0x4600 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x4600 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x4400 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_MITE, 0x4600 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x4600 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x4800 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x3e00 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x4a00 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_DIRSWC, 0x4800 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
...
/* low sub threshold */
.set FPL_GATE_S_SWC, 0x3c00 /* Gate(SWC) = gnd */
...
.set FPL_GATE_S_OTA, 0x2c00 /* Gate(OTA) = 2.5V */
...
.set FPL_GATE_S_OTAREF, 0x3400 /* Gate(OTAREF) = gnd */
...
.set FPL_GATE_S_MITE, 0x2e00 /* Gate(MITE) = 2.0V */
...
.set FPL_GATE_S_DIRSWC, 0x3c00 /* Gate(DIRSWC) = 1.4V */
...
.set FPH_GATE_S_SWC, 0x4800 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
.set FPH_INJ_T_SWC, 1 /* Injection time (*10us) */
.set FPH_NUM_SWC, 50 /* # of Fine Progrm */
.set FPH_VD_A_SWC, 8 /* Vd constant A */
.set FPH_VD_B_SWC, 3 /* Vd constant B */
.set FPH_VD_OS_SWC, 21 /* Vd table offset */
.set FPH_VD_SA_SWC, 1 /* 0:Subtraction 1:Add */
.set FPH_VD_GND_SWC, 0 /* 0:Vd table 1:GND */
.set FPH_GATE_S_OTA, 0x4000 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
.set FPH_INJ_T_OTA, 3 /* Injection time (*10us) */
.set FPH_NUM_OTA, 50 /* # of Fine Progrm */
.set FPH_VD_A_OTA, 8 /* Vd constant A */
.set FPH_VD_B_OTA, 3 /* Vd constant B */
.set FPH_VD_OS_OTA, 21 /* Vd table offset */
.set FPH_VD_SA_OTA, 1 /* 0:Subtraction 1:Add */
.set FPH_VD_GND_OTA, 0 /* 0:Vd table 1:GND */
