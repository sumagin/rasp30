...
/* above & sub threshold */
.set CP_GATE_S_SWC, 0x7030 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set CP_GATE_S_MITE, 0x7030 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set CPL_GATE_S_OTA, 0x3f30 /* Gate(OTA) = 2.1V */
...
.set CPL_GATE_S_MITE, 0x3f30 /* Gate(MITE) = 2.1V */
.set CPL_INJ_T_MITE, 1 /* Injection time (*10us) */
.set CPL_NUM_MITE, 20 /* # of Measured Coarse Progrm */
.set CPL_GATE_S_DIRSWC, 0x0e30 /* Gate(DIRSWC) = 1.7V */
