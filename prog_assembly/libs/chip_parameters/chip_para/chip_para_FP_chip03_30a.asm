...
/**********************************/
.set ADC_1nA, 5637 /* 1nA ADC value */
...
.set FPS_GATE_S_DIRSWC, 0x7630 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
.set FPL_GATE_S_OTA, 0x4330 /* Gate(OTA) = 2.1V */
...
.set FPL_GATE_S_MITE, 0x4330 /* Gate(MITE) = 2.1V */
...
.set FPL_GATE_S_DIRSWC, 0x1D30 /* Gate(DIRSWC) = 1.7V */
