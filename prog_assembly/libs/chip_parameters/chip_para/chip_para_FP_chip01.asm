...
/**********************************/
.set ADC_1nA, 4139 /* 1nA ADC value */
...
.set FPS_VD_OS_OTA, 48 /* Vd table offset */
...
.set FPS_VD_OS_OTAREF, 52 /* Vd table offset */
...
.set FPS_VD_OS_MITE, 47 /* Vd table offset */
...
.set FPS_VD_OS_DIRSWC, 39 /* Vd table offset */
...
.set FPA_VD_OS_SWC, 27 /* Vd table offset */
...
.set FPA_VD_OS_OTA, 31 /* Vd table offset */
...
.set FPA_VD_OS_MITE, 35 /* Vd table offset */
...
.set FPL_VD_OS_SWC, 51 /* Vd table offset */
...
.set FPL_VD_OS_OTA, 43 /* Vd table offset */
