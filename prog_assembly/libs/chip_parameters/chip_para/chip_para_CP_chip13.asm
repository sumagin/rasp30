...
/* above & sub threshold */
.set CP_GATE_S_SWC, 0x5800 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set CP_GATE_S_MITE, 0x4a00 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
