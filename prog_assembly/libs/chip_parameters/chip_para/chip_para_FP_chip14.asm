...
/* sub threshold */
.set FPS_GATE_S_SWC, 0x4c00 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x4800 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x4600 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x4c00 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x4400 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x4600 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x4800 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
