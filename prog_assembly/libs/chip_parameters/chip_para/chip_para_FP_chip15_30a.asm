...
/**********************************/
.set ADC_1nA, 4396 /* 1nA ADC value */

/* sub threshold */
.set FPS_GATE_S_SWC, 0x6c30 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x6c30 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x6c30 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_MITE, 0x6c30 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x6c30 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x6c30 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x6c30 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x6c30 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x6c30 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_DIRSWC, 0x6c30 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
.set FPL_GATE_S_OTA, 0x3b30 /* Gate(OTA) = 2.1V */
...
.set FPL_GATE_S_MITE, 0x3b30 /* Gate(MITE) = 2.1V */
...
.set FPL_GATE_S_DIRSWC, 0x0b30 /* Gate(DIRSWC) = 1.7V */
