...
/**********************************/
.set ADC_1nA, 4816 /* 1nA ADC value */
...
.set FPS_GATE_S_OTA, 0x7230 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPL_GATE_S_OTA, 0x3930 /* Gate(OTA) = 2.1V */
...
.set FPL_GATE_S_MITE, 0x3930 /* Gate(MITE) = 2.1V */
