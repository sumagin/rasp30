	...
	print "getting here!"
	    ...
	    #print sb
		    ...
		    for s in range(len(ex_fg)):
				...
				if swc_name0 in["ladder_blk[0]","hhneuron[0]","c4_blk[0]","speech[0]","INFneuron[0]","lpf[0]","peak_detector[0]","ramp_fe[0]",'sigma_delta_fe[0]','nmirror_vmm[0]']:
					#pdb.set_trace()
					swc_name1 = j
				#elif 
